...
def sidebar():
    return rx.vstack(
        ...
        rx.spacer(),
        rx.vstack(
            rx.link("Mis Parcelas", href="/parcelas", color="rgba(255,255,255,0.8)", font_size="0.9rem", width="100%", padding="0.5rem", _hover={"color": VERDE}),
            rx.link("Mis Cultivos", href="/cultivos", color="rgba(255,255,255,0.8)", font_size="0.9rem", width="100%", padding="0.5rem", _hover={"color": VERDE}),
            rx.link("Actividades", href="/actividades", color="rgba(255,255,255,0.8)", font_size="0.9rem", width="100%", padding="0.5rem", _hover={"color": VERDE}),
            rx.link("Reportes", href="/reportes", color="rgba(255,255,255,0.8)", font_size="0.9rem", width="100%", padding="0.5rem", _hover={"color": VERDE}),
            rx.link("Mi Perfil", href="/perfil", color="rgba(255,255,255,0.8)", font_size="0.9rem", width="100%", padding="0.5rem", _hover={"color": VERDE}),
            width="100%",
...
def contenido():
    return rx.vstack(
        rx.cond(
            AuthState.mensaje_bienvenida != "",
            rx.box(
                rx.text(AuthState.mensaje_bienvenida, font_size="0.9rem", color=VERDE),
                padding="1rem",
                bg="#E6F7E4",
                border_radius="8px",
                width="100%",
        ...
        rx.grid(
            rx.link(
                rx.box(
                    ...
                    width="100%",
                    _hover={"box_shadow": "0 4px 6px rgba(0,0,0,0.15)"},
                ),
                href="/parcelas", width="100%",
            ),
            rx.link(
                rx.box(
